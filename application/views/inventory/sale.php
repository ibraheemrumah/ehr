...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#chemicallist" data-toggle="tab"><i class="fas fa-list-ul"></i> <?php echo translate('Drug sale') . ' ' . translate('list'); ?></a>
			</li>
<?php if (get_permission('chemical_purchase', 'is_add')): ?>
			<li>
				<a href="#create" data-toggle="tab"><i class="far fa-edit"></i> <?php echo translate('add') . ' ' . translate('Drug sale'); ?></a>
			</li>
<?php endif; ?>
		</ul>
		<div class="tab-content">
			<div id="chemicallist" class="tab-pane active mb-md">
				<div class="export_title"><?php echo translate('Sale') . " " . translate('report'); ?></div>
				<table class="table table-bordered table-hover table-condensed" cellspacing="0" width="100%" id="table-export">
					<thead>
						<tr>
							...
							<th><?php echo translate('sale') . " " . translate('date'); ?></th>
					...
					<tbody>
						<?php if (!empty($salelist)){ foreach ($salelist as $row): ?>	
						<tr>
...
<?php if (get_permission('chemical_purchase', 'is_add')){ ?>
			<div id="create" class="tab-pane">
				<?php echo form_open('inventory/sale_save', array('id' => 'frmSubmit')); ?>
				<div class="row mb-lg">
				<div class="col-md-6 mt-sm">
						<div class="form-group">
							...
							<?php
									echo form_dropdown("supplier_id", $patientlist, set_value("supplier_id"), "class='form-control' data-plugin-selectTwo id='supplier_id'
									data-width='100%' ");
								?>
				...
				<div class="col-md-3 mt-sm">
						<div class="form-group">
							<label class="control-label"><?php echo translate('bill_no'); ?> <span class="required">*</span></label>
				...
				<div class="col-md-3 mt-sm">		
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover mt-md" id="tableID">
							<thead>
								<th><?php echo translate('Drug'); ?> <span class="required">*</span></th>
	...
	$(document).ready(function() {
		$(document).on('change', '.purchase_chemical', function() {
			...
			$.ajax({
				type: "POST",
				data: {'id' : id},
				url: "<?php echo base_url('ajax/get_chemical_sprice'); ?>",
...
<?php foreach ($chemicallist as $chemical): ?>
		html_row += '<option value="<?php echo html_escape($chemical['id']) ?>" ><?php echo html_escape($chemical['name']) ?></option>';
<?php endforeach; ?>
		html_row += '</select>';
